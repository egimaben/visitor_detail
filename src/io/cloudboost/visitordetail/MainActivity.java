...
public class MainActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		 ...
		 * the first parameter is app id 
		 * and the second is the client key. 
		 * please replace accordingly
		 */
		
		CloudApp.init("xxxxxxx", "xxxxxxxxxxxxxxxxxxx");
		try {
			/*start listening to "created" events 
			 * on visitor_detail table. 
			 * the other 2 types of events are "updated" and "deleted"
			 */
			
			CloudObject.on("visitor_detail", "created", new CloudObjectCallback() {
